...
<div class="contrainer p-4">
    ...
    <form action="{{ route('carmodel.update',['carmodel' => $carmodel->id]) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="carmodel" name="carmodel" value = "{{ $carmodel->model_name }}" required>
                            @error('carmodel')
                            <div class="my-2">
