...
@section('title', setting('title'). ' | จัดการโมเดลรถยนต์')
@php $pagename = 'จัดการโมเดลรถ'; @endphp
@section('content')
<div class="contrainer p-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-7 col-sm-8">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('carmodel.multidel') }}" id="form_multidel">
                        @csrf
                        <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">แก้ไขโมเดลรถ</h5>
                </div>
                    <div class="modal-body">

                        <div class="form-group">
                            <label>ชื่อโมเดลรถ</label>
                            <input type="hidden" id="carmodel_id" value="">
                            <input type="text" class="form-control" id="carmodel_edit" name="carmodel_edit" required>
                        </div>

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                        <input type="submit" onclick="updatecarmodal()" class="btn btn-success savebtn" value="บันทึก">
                    </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var table;
            ...
            function modaledit(id) {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ url('admin/carmodel') }}/" +id,
                    success: function (response) {
                        $('#carmodel_id').val(response.id)
                        $('#carmodel_edit').val(response.model_name)
